      ...
      double a,double r1)
{
   ...
   double vc_orb = sqrt(r->G*(mtot+1)/a); // correct +1 here  for extended body
   double om_orb = vc_orb/a; // no correction here
   double xoff = -a;
   double vyoff = -vc_orb;
...
// m1 = mp and m2 = mratio*mp
// masses are separated by distance sep, circular orbit
// center of mass of PC and velocity set to be in orbit with given orbtal elements
// return mean motion around PC
...
/////////////////////////////////
// drift the semi-major axis of a binary  using Beauge et al. 06's
...
// and will probably work for binarys with various mass ratios
/////////////////////////////////////////////////////////////
